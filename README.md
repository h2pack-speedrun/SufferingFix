...
> A bug fix that ensures the "Suffering on Sight" curse correctly bypasses the "Wards" vow.

## Features

- Fixes a bug where the "Suffering on Sight" curse (from the Pact of Punishment) would not deal damage to enemies protected by the "Wards" vow.
- Ensures the curse works as intended, dealing damage regardless of enemy wards.
